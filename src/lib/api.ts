...
export async function loadApiKeys(): Promise<ApiKeys> {
  ...
  const defaultKeys: ApiKeys = {
    openai:
      "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",
